...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2020 a las 16:13:13
...
(9, 5, 1, 'Pruebaasas', 'Pruebaasas', '13-08-2020'),
(10, 5, 1, 'PRUEBAas', 'PRUEBAas', '14-08-2020'),
(11, 6, 3, 'NO REACTIVO', 'SI ', '17-10-2020');
...
INSERT INTO `tap_informemedico` (`idinforme_medico`, `idasistenciales`, `idpaciente`, `diagnostico`, `fecha_registro`, `fecha_system`) VALUES
...
(1, '1013', 'DNI', '76244567', 'YOSSHI SALVADOR', 'CONDOR', 'MENDIETE', 'PEDANDKJNKASNDA VQD9012312 SADASD', '917023453', '02/10/1994', 'CAÑETE', 'FEMENINO', '25 Años 10 Meses y 13 Dias', 'CASADO', 'DESARROLLADOR DE SOFTWARE', 'GRANULOMA TBC', 'NINGUNA', 'DEXAMETASONA', 'Administrador', '15-08-2020'),
...
--
ALTER TABLE `tap_certificadosalud`
  MODIFY `idcertificado_salud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tap_consumo`
  MODIFY `idconsumo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `tap_farmacia`
--
ALTER TABLE `tap_farmacia`
  MODIFY `idfarmacia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `tap_informemedico`
--
ALTER TABLE `tap_informemedico`
  MODIFY `idinforme_medico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
